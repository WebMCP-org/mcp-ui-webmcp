/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b485d1b53c757c2d89b5dcf4a2ec1bd4)
// Runtime types generated with workerd@1.20251011.0 2025-10-11 nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./worker/index');
    durableNamespaces: 'MyMCP' | 'GameStatsStorage';
  }
  interface Env {
    APP_URL: string;
    MCP_OBJECT: DurableObjectNamespace<import('./worker/index').MyMCP>;
    GAME_STATS: DurableObjectNamespace<import('./worker/index').GameStatsStorage>;
  }
}
