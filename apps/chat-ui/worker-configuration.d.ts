/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fddb04a9a0da86600b4f1911d4094ff5)
// Runtime types generated with workerd@1.20251011.0 2025-10-11 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "UsageQuota";
	}
	interface Env {
		...
		SENTRY_DSN: string;
		ENVIRONMENT: string;
		USAGE_QUOTA: DurableObjectNamespace<import("./worker/index").UsageQuota>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "ANTHROPIC_API_KEY" | "SENTRY_DSN" | "ENVIRONMENT">> {}
}
