/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 051ee1c12ee5b6ccb6d267b5201f1dda)
// Runtime types generated with workerd@1.20251011.0 2025-10-11 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "VanillaTemplateMCP";
	}
	interface Env {
		APP_URL: string;
		MCP_OBJECT: DurableObjectNamespace<import("./worker/index").VanillaTemplateMCP>;
		ASSETS: Fetcher;
	}
}
